...
def main():
    ...
    if args.scheduler == 'cos':
        ...
        scheduler = torch.optim.lr_scheduler.OneCycleLR(optimizer, max_lr=args.lr, steps_per_epoch=1, epochs=args.epochs, pct_start=0.2)
    ...
    for epoch in range(initial_epoch, args.epochs + 1):
        ...
        ### validation
        print("evaluation ...")
        score = evaluation(model, val_loader, COCO_ATTRIBUTE_NAMES, writer, epoch, result_dir_path=None)
